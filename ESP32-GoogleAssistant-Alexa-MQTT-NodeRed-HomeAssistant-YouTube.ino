...
const char * inTopic      = "ESP32/SeuTópico/inTopic";            // Somente por MQTT
const char * outTopic     = "ESP32/SeuTópico/outTopic";           // Somente por MQTT
...
#define APP_KEY           "APK-KEY Única, você ever por a sua aqui"        //Site https://portal.sinric.pro/ para conseguir a APP-KEY 
#define APP_SECRET        "APP-SECRET Única, você ever por a sua aqui"     //Site https://portal.sinric.pro/ para conseguir a APP-SECRET

//Enter the device IDs here
#define device_ID_1   "Crie Seus Devices e cole aqui os IDs"  //Site https://portal.sinric.pro/ para conseguir a ID Device
#define device_ID_2   "Crie Seus Devices e cole aqui os IDs"  //Site https://portal.sinric.pro/ para conseguir a ID Device
#define device_ID_3   "Crie Seus Devices e cole aqui os IDs"  //Site https://portal.sinric.pro/ para conseguir a ID Device
...
const char * SSID = "Sua Rede Wi-Fi";               // SSID / nome da rede WI-FI que deseja se conectar
const char * PASSWORD = "Sua Senha Wi-Fi"; // Senha da rede WI-FI que deseja se conectar

// Configurações do Broker MQTT
const char * BROKER_MQTT  = "Aqui, vai um Broker público ou Broker local";    // URL do broker MQTT que se deseja utilizar
const char * mqttUserName = "User Name do MQTT Broker";     // MQTT UserName
const char * mqttPwd      = "Senha do Broker MQTT";         // MQTT Password
